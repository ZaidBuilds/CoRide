...
export const DELHI_METRO_LINES: MetroLine[] = [
  {
    ...
    stations: [
      ...
      { id: 'dwarka_sec_8', name: 'Dwarka Sector 8', hindiName: 'द्वारका सेक्टर ८', lat: 28.5657, lng: 77.0671, lineId: 'blue', order: 2, isInterchange: false, isUnderground: false, cellTowerId: 'TOWER_DMRC_DWK8', averagePressureHpa: 1008.3 },
      ...
      { id: 'barakhamba_road', name: 'Barakhamba Road', hindiName: 'बाराखंभा रोड', lat: 28.6298, lng: 77.2245, lineId: 'blue', order: 20, isInterchange: false, isUnderground: true, cellTowerId: 'TOWER_DMRC_BKRD', averagePressureHpa: 1012.5 },
      ...
      { id: 'mayur_vihar_1', name: 'Mayur Vihar 1', hindiName: 'मयूर विहार १', lat: 28.6044, lng: 77.2896, lineId: 'blue', order: 26, isInterchange: true, interchangeLines: ['pink'], isUnderground: false, cellTowerId: 'TOWER_DMRC_MV1', averagePressureHpa: 1007.9 },
      { id: 'mayur_vihar_ext', name: 'Mayur Vihar Extension', hindiName: 'मयूर विहार एक्सटेंशन', lat: 28.5943, lng: 77.2945, lineId: 'blue', order: 27, isInterchange: false, isUnderground: false, cellTowerId: 'TOWER_DMRC_MVEX', averagePressureHpa: 1008.0 },
      { id: 'new_ashok_nagar', name: 'New Ashok Nagar', hindiName: 'न्यू अशोक नगर', lat: 28.5892, lng: 77.3018, lineId: 'blue', order: 28, isInterchange: false, isUnderground: false, cellTowerId: 'TOWER_DMRC_NASH', averagePressureHpa: 1008.0 },
      { id: 'noida_sec_15', name: 'Noida Sector 15', hindiName: 'नोएडा सेक्टर १५', lat: 28.5849, lng: 77.3115, lineId: 'blue', order: 29, isInterchange: false, isUnderground: false, cellTowerId: 'TOWER_DMRC_N15', averagePressureHpa: 1008.0 },
  ...
  },
  {
    ...
    stations: [
      ...
      { id: 'mayur_vihar_1_p', name: 'Mayur Vihar 1', hindiName: 'मयूर विहार १', lat: 28.6044, lng: 77.2896, lineId: 'pink', order: 12, isInterchange: true, interchangeLines: ['blue'], isUnderground: false, cellTowerId: 'TOWER_DMRC_MV1', averagePressureHpa: 1007.9 },
  ...
  },
  {
    ...
    stations: [
      { id: 'dwarka_g', name: 'Dwarka', hindiName: 'द्वारका', lat: 28.6154, lng: 77.0224, lineId: 'grey', order: 1, isInterchange: true, interchangeLines: ['blue'], isUnderground: false, cellTowerId: 'TOWER_DMRC_DWKA', averagePressureHpa: 1008.2 },
